...
class BollywoodViewController: UIViewController,UIScrollViewDelegate {
     ...
     func creatingComponents()
                 {
                             ...
                             DispatchQueue.main.async
                             {
                                 if (self.moviesDict[i.title!] == "bollywood")
                                 {
                                     ...
                                     moviePosterBtn.backgroundColor = UIColor.black
                                         ...
                                         trailerBtn.heightAnchor.constraint(equalToConstant: 45).isActive = true
                                         trailerBtn.setImage(UIImage(named: "trailer"), for: UIControl.State.normal)
                                     trailerBtn.backgroundColor = .black
                                     trailerBtn.setTitle("Trailer", for: UIControl.State.normal)
                     ...
                     songsBtn.setTitle("Songs", for: UIControl.State.normal)
                 songsBtn.translatesAutoresizingMaskIntoConstraints = false
                                     songsBtn.backgroundColor = .black
...
//                                         songsBtn.setImage(UIImage(named: "mp3"), for: UIControl.State.normal)
                 ...
                 detailsBtn.setTitle("Details", for: UIControl.State.normal)
                 detailsBtn.backgroundColor = .black
